      ...
      <section className="relative h-screen flex items-center justify-center text-white text-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Build High-Performance, Cross-Platform Apps with Xamarin
          </h1>
          <p className="text-lg md:text-xl mb-6">
            Develop fast, scalable, and native-like mobile applications for iOS,
            Android, and Windows using C# and .NET with Xamarin.
          </p>
