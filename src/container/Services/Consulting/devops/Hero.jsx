import consultingHero from "../../../../assets/ConsultingVideo.mp4"; // Import your video
...
function Hero() {
  ...
  const text = "Devops Consulting Service";
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        ...
        >
          <source
            src={consultingHero} // Replace with your video URL
            type="video/mp4"
          />
        </video>
      </div>
      ...
      <div className="relative flex items-center justify-center z-20 min-h-screen px-4 py-20">
        <div className="max-w-6xl mx-auto text-center transform hover:scale-105 transition-transform duration-700">
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-12 animate-glow">
            Optimize your development lifecycle with our DevOps consulting
            <span className="relative inline-block group mx-2">
              helping you streamline processes
            ...
            improve collaboration, and accelerate delivery
          </p>
